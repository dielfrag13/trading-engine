...
# i think we need a paid sub for this

session = boto3.Session(
    aws_access_key_id='b47140a3-6eeb-4f16-99df-571a88b094e7',
    aws_secret_access_key='KpC4SKd788qd7GN9BNRahK97X2t5Pljl',
)
...
object_key = 'us_stocks_sip/trades_v1/2024/03/2025-08-29.csv.gz'
